...
export const projects: Project[] = [
  ...
  { id: 21, slug: "urban-eco-park", name: "Urban Eco-Park Energy Station", location: "China", system: "Lumina Slate", application: "Infrastructure", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/urban-eco-park/",
  ...
  { id: 22, slug: "custom-red-bipv-solutions", name: "Custom Red BIPV Solutions", location: "China", system: "Lumina Slate", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/custom-red-bipv-solutions/",
  ...
  { id: 23, slug: "modern-minimalist-residence", name: "Modern Minimalist Residence", location: "China", system: "Lumina Slate", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/modern-minimalist-residence/",
  ...
  { id: 24, slug: "pioneer-residential-retrofit", name: "Pioneer Residential Retrofit", location: "China", system: "Lumina Slate", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/pioneer-residential-retrofit/",
  ...
  { id: 25, slug: "premium-waterfront-estate", name: "Premium Waterfront Estate", location: "China", system: "Lumina Slate", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/premium-waterfront-estate/",
  ...
  { id: 26, slug: "public-utility-infrastructure", name: "Public Utility Infrastructure", location: "China", system: "Lumina Slate", application: "Infrastructure", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/public-utility-infrastructure/",
