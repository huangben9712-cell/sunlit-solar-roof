...
export interface Project {
  ...
  name: string;
  location: string;
  system: "Lumina Slate" | "Storm Guard" | "Others";
  application: string;
  overview?: string;
  challenge?: string;
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: "Hangzhou Xianghu Arcadia Villa",
  ...
  },
  {
    ...
    name: "Nanjing Nanshan Lake Resort",
    location: "China",
    system: "Lumina Slate",
  ...
  },
  {
    ...
    name: "Jiaxing Boutique Homestay",
    location: "China",
    system: "Lumina Slate",
    application: "Hospitality",
  ...
  },
  {
    ...
    name: "Large-Scale Commercial Complex",
    location: "China",
    system: "Storm Guard",
    application: "Commercial",
  ...
  { id: 9, slug: "beijing-poly-longshang-luxury-villa-bipv-integration-on-complex-roof-geometry", name: "Beijing Poly Longshang Luxury Villa", location: "China", system: "Lumina Slate", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/beijing-poly-longshang-luxury-villa-bipv-integration-on-complex-roof-geometry/",
  ...
  { id: 10, slug: "beijing-tanxiangshan-villa", name: "Beijing Tanxiangshan Villa", location: "China", system: "Lumina Slate", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/beijing-tanxiangshan-villa/",
  ...
  { id: 11, slug: "hangzhou-eco-tech-building", name: "Hangzhou Eco-Tech Building", location: "China", system: "Lumina Slate", application: "Commercial", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/hangzhou-eco-tech-building/",
  ...
  { id: 12, slug: "hangzhou-jiuxi-rose-garden", name: "Hangzhou Jiuxi Rose Garden", location: "China", system: "Lumina Slate", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/hangzhou-jiuxi-rose-garden/",
  ...
  { id: 13, slug: "hangzhou-yunxi-diegu-villa", name: "Hangzhou Yunxi Diegu Villa", location: "China", system: "Lumina Slate", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/hangzhou-yunxi-diegu-villa/",
  ...
  { id: 14, slug: "nanjing-shanshui-huamen-villa-custom-solar-integration-on-complex-rooflines", name: "Nanjing Shanshui Huamen Villa", location: "China", system: "Lumina Slate", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/nanjing-shanshui-huamen-villa-custom-solar-integration-on-complex-rooflines/",
  ...
  { id: 15, slug: "shanghai-ansheng-huayuan-villa", name: "Shanghai Ansheng Huayuan Villa", location: "China", system: "Lumina Slate", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/shanghai-ansheng-huayuan-villa/",
  ...
  { id: 16, slug: "shanghai-hongqiao-royal-villa", name: "Shanghai Hongqiao Royal Villa", location: "China", system: "Lumina Slate", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/shanghai-hongqiao-royal-villa/",
  ...
  { id: 17, slug: "suzhou-urban-relay-station", name: "Suzhou Urban Relay Station", location: "China", system: "Lumina Slate", application: "Infrastructure", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/suzhou-urban-relay-station/",
  ...
  { id: 18, slug: "yiwu-golf-villa", name: "Yiwu Golf Villa", location: "China", system: "Lumina Slate", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/yiwu-golf-villa/",
  ...
  { id: 19, slug: "urban-low-slope-extension", name: "Urban Low-Slope Extension", location: "China", system: "Storm Guard", application: "Residential", overview: "Legacy Storm Guard reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/urban-low-slope-extension/",
  ...
  { id: 20, slug: "urban-compact-home-retrofit", name: "Urban Compact Home Retrofit", location: "China", system: "Storm Guard", application: "Residential", overview: "Legacy Storm Guard reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/urban-compact-home-retrofit/",
  ...
  { id: 21, slug: "urban-eco-park", name: "Urban Eco-Park Energy Station", location: "China", system: "Others", application: "Infrastructure", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/urban-eco-park/",
  ...
  { id: 22, slug: "custom-red-bipv-solutions", name: "Custom Red BIPV Solutions", location: "China", system: "Others", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/custom-red-bipv-solutions/",
  ...
  { id: 23, slug: "modern-minimalist-residence", name: "Modern Minimalist Residence", location: "China", system: "Others", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/modern-minimalist-residence/",
  ...
  { id: 24, slug: "pioneer-residential-retrofit", name: "Pioneer Residential Retrofit", location: "China", system: "Others", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/pioneer-residential-retrofit/",
  ...
  { id: 25, slug: "premium-waterfront-estate", name: "Premium Waterfront Estate", location: "China", system: "Others", application: "Residential", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/premium-waterfront-estate/",
  ...
  { id: 26, slug: "public-utility-infrastructure", name: "Public Utility Infrastructure", location: "China", system: "Others", application: "Infrastructure", overview: "Legacy project reference migrated from the old website. Keep as a visual and application reference; expand with verified details in a later pass.", status: "Reference", sourceUrl: "https://www.sunlitsolarroof.com/project/public-utility-infrastructure/",
